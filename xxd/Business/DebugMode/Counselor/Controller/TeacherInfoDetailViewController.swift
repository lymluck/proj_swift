...
fileprivate class HeaderView: UIView {
    ...
    lazy var playerView: RxPlayerView = {
        let view = RxPlayerView(frame: CGRect(x: 0, y: 0, width: XDSize.screenWidth, height: headerVideoViewHeight))
...
//        view.addGestureRecognizer(tapGesture)
    ...
    override init(frame: CGRect) {
        ...
        // 点赞
        videoView.addSubview(likeViewBackgroundView)
...
extension HeaderView: RxPlayerViewDelegate {
    
    func fullScreenResponse(view: RxPlayerView, isFullScreen: Bool) {
