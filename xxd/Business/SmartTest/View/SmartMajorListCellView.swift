...
class SmartMajorListCellView: UITableViewCell {
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        chineseName.snp.makeConstraints { (make) in
            ...
            make.top.equalTo(stageView).offset(23)
        }
        ...
        localRank.snp.makeConstraints { (make) in
            make.left.right.equalTo(chineseName)
            make.top.equalTo(englishName.snp.bottom).offset(10)
        }
